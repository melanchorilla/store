    ...
    <tr>
      ...
      <td style="width:50%; vertical-align: text-bottom; padding: 10px;">
        ...
        <table>
          ...
          <tr>
            <td style="font-size: 13px;">PEMBAYARAN</td><td style="font-size: 12px;">:
              <?php
                if($datainvoice->metode_pembayaran=='1'){
          ...
          <tr>
            <?php
              $dataduitku = DB::table('duitku')->where('no_invoice', $no_invoice)->first();
              $cekstatus = $dataduitku->trxstatus;
            ?>
            <td style="font-size: 13px;">STATUS</td><td style="font-size: 12px;">:
              <?php
...
<?php if($datainvoice->metode_pembayaran=='1'){ ?>
<table style="width:100%; margin-top: 20px; margin-bottom: 20px;">
  <tr>
